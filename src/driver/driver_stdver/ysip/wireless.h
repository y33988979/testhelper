...
/*
* hi hi hi
* it's so important that you must be carefull when using it
* this struct is used to be exchange info&data with device or driver or kernel or ...
* here we use a macro to switch which version suitable for current envirement
*/
/*
