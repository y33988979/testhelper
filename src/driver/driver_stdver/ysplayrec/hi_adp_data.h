...
{
    HI_U32 u32TunerPort; /*Tuner 的通道号*/
    HI_U32 u32Frequency;  /*单位MHZ */
    HI_U32 u32SymbolRate; /* 单位KHZ*/
...
typedef struct hiDB_FRONTEND_S
{
    ...
    union
    {
	 FE_TYPE_FILE_S  sFEParaFile;  //文件类型
        FE_TYPE_IP_S    sFEParaIp;  //IP类型
        FE_TYPE_RF_S    sFEParaRf; //RF类型
    }unFEtype;
