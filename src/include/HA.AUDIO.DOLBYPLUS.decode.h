...
#define    HA_DOLBY_PLUS_ID 0x1010        
#define    HA_AUDIO_ID_DOLBY_PLUS   HA_BUILD_CODEC_ID(VENDOR_HISI,FORMAT_MULTI,HA_DOLBY_PLUS_ID)   /**< support FORMAT_AC3, FORMAT_EAC3 */
