...
/* $Revision: 1.6.14.2.18.2 $ on $Date: 2011/10/10 09:03:43 $ */
...
#ifdef GL_GLEXT_PROTOTYPES
GL_APICALL void GL_APIENTRY glTexDirectVIV (GLenum Target, GLsizei Width, GLsizei Height, GLenum Format, GLvoid ** Pixels, GLuint Address[3]);
GL_APICALL void GL_APIENTRY glTexDirectInvalidateVIV (GLenum Target);
#endif
typedef void (GL_APIENTRYP PFNGLTEXDIRECTVIVPROC) (GLenum Target, GLsizei Width, GLsizei Height, GLenum Format, GLvoid ** Pixels, GLuint Address[3]);
