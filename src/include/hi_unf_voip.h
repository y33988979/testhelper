...
/**
 * \file
 * \brief Describes the information about the voice over Internet Protocol (VoIP) engine.CNcomment:提供VOIP语音引擎的相关信息
 */
...
/** \addtogroup      H_2_2_14 */
/** @{ */  /**<!—[VoIP data structure]*/ /**<CNcomment:!-- 【VOIP数据结构】 */
...
/**
Defines the enumeration type of the attribute ID of the VoIP channel. CNcomment:定义VOIP 通道属性ID枚举类型  
Note: The enumeration type must be consistent with OPEN_CHN_PARA_ENUM in HME_Api.h. CNcomment:注意 : 该枚举类型必须与HME_Api.h中的OPEN_CHN_PARA_ENUM 定义一致。
*/
...
/**
Define voip audio device type. CNcomment:定义VOIP音频设备枚举类型
*/
...
/**
Define voip audio device input and output type. CNcomment:定义VOIP音频设备输入输出类型
*/
...
typedef struct hiUNF_VOICE_CONFIG_BODY_S
{
    ...
    HI_U8   u8InputGain;        /**<Input gain. Its value range is [0, 15]. The value 0 indicates -10 dB, and the value 15 indicates 5 dB. The same rule is applicable to other values. The default value is 10 (0 dB). This parameter corresponds to the change bit bit1InputGain.*/
                                /**<CNcomment:输入增益 [0 ~ 15] (对应-10 dB~5 dB) , 缺省值为10 (0dB) ,  对应变更标志 bit1InputGain */
    HI_U8   u8OutputGain;       /**<Input gain. Its value range is [0, 20]. The value 0 indicates -10 dB, and the value 20 indicates 10 dB. The same rule is applicable to other values. The default value is 10 (0 dB). This parameter corresponds to the change bit bit1OutputGain.*/
                                /**<CNcomment:输出增益 [0 ~ 20] (对应-10dB~10dB), 缺省值为10 (0dB),  对应变更标志 bit1OutputGain */
    HI_U16  u16Rsev;
...
/**
 \brief Initializes the VoIP module. CNcomment: 初始化VOIP模块
 \attention \n
 \param N/A
 \retval ::0 Success CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_DEV_OPEN_ERR  The device fails to be started. CNcomment:设备打开错误
 \retval ::HI_ERR_VOIP_HME_DEV_NOT_EXIST  The device does not exist. CNcomment:设备不存在
 \retval ::HI_ERR_VOIP_HME_NOT_DEV_FILE  The file is not a device file. CNcomment:不是设备文件
 \retval ::HI_ERR_VOIP_HME_NO_INIT    The thread for processing VoIP events fails to be initialized. CNcomment:EVENT初始化失败
 \see \n
N/A
 */
...
/**
 \brief Deinitializes the VoIP module. CNcomment:去初始化VOIP模块
 \attention \n
 \param N/A
 \retval ::0 Success CNcomment:成功
 \see \n
...
/**
 \brief Obtains the default configuration of an VoIP channel. CNcomment:获取缺省的VOIP 通道配置
 \attention \n
 ...
 \param[out] pstDefChAttr  Pointer to the default VoIP channel attributes. For details, see :HI_UNF_VOIP_CHN_ATTR_S. CNcomment:指针类型，VOIP 通道默认属性，参见:HI_UNF_VOIP_CHN_ATTR_S
 \retval ::0 Success CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA   The input parameter is invalid. CNcomment:无效的输入参数
 \retval ::HI_ERR_VOIP_HME_NULL_PTR  The pointer is null. CNcomment:空指针
 \see \n
N/A
 */
...
/**
 \brief Creates a VoIP channel. CNcomment:创建VOIP 通道
 \attention \n
 ...
 CNcomment:创建通道前，建议先调用HI_UNF_VOIP_GetChDefaultAttr()获取默认通道属性，再对参数做必要修改。
 \param[in] enWorkMode       Working mode of a VoIP channel. For details, see ::HI_UNF_VOIP_WORKMODE_E. CNcomment:VOIP 通道工作模式，请参见::HI_UNF_VOIP_WORKMODE_E
 \param[in]  pstChAttr  Pointer to VoIP channel attributes. For details, see ::HI_UNF_VOIP_CHN_ATTR_S. CNcomment:指针类型，VOIP 通道属性，请参见::HI_UNF_VOIP_CHN_ATTR_S
 \param[out] phVoip   Pointer to the handle of a created VoIP channel CNcomment:指针类型，创建的VOIP 通道句柄
 \retval ::0 Success CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_NULL_PTR  The pointer is null. CNcomment:空指针
 \retval ::HI_ERR_VOIP_HME_CREATE_ERR   A channel fails to be created. CNcomment:创建通道失败
 \retval ::Other values  A channel fails to be created. CNcomment:其它  创建通道失败
 \see \n
N/A
 */
...
/**
 \brief Destroys a VoIP channel. CNcomment:销毁VOIP 通道
 \attention \n
N/A
 \param[in] hVoip  VoIP channel handle CNcomment:VOIP 通道句柄
 \retval ::0 Success CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA  The parameter is invalid. CNcomment:无效参数
 \retval ::HI_ERR_VOIP_HME_DESTROY_ERR   A channel fails to be destroyed. CNcomment:销毁通道失败
...
/**
 \brief Obtains the configuration of a VoIP channel. CNcomment:获取VOIP 通道配置
 \attention \n
 \param[in] hVoip  VoIP channel handle CNcomment:VOIP 通道句柄
 \param[out] pstChAttr  Pointer to VoIP channel attributes. For details, see :HI_UNF_VOIP_CHN_ATTR_S. CNcomment:指针类型，VOIP 通道属性，参见:HI_UNF_VOIP_CHN_ATTR_S
 \retval ::0 Success CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA   The input parameter is invalid. CNcomment:无效的输入参数
 \retval ::HI_ERR_VOIP_HME_NULL_PTR  The pointer is null. CNcomment:空指针
...
/**
 \brief Modifies the configuration of a VoIP channel. CNcomment:修改VOIP 通道配置
 \attention \n
        ...
        CNcomment:建议先调用HI_UNF_VOIP_GetChAttr()获取当前通道配置，再对参数做必要修改，对应的更改标记置1，无关更改标志置0。
 \param[in] hVoip  VoIP channel handle CNcomment:VOIP通道句柄
 \param[in] pstChAttr  Pointer to VoIP channel attributes. For details, see :HI_UNF_VOIP_CHN_ATTR_S. CNcomment:指针类型，VOIP 通道属性，参见:HI_UNF_VOIP_CHN_ATTR_S
 \retval ::0 Success CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA   The input parameter is invalid. CNcomment:无效的输入参数
 \retval ::HI_ERR_VOIP_HME_NULL_PTR  The pointer is null. CNcomment:空指针
...
#if 0
/**
 \brief Obtains the sub attributes of a VoIP channel. CNcomment:获取VOIP 通道子属性
 \attention \n
 \param[in] hVoip  VoIP channel handle CNcomment:VOIP 通道句柄
 \param[in] enAttrID  ID of the VoIP channel configuration parameter. For details, see :HI_UNF_VOIP_ATTR_ID_E. CNcomment:VOIP 通道配置参数ID，参见: HI_UNF_VOIP_ATTR_ID_E
 \param[out] pChSubAttr  Pointer to the sub attributes of a VoIP channel. The data structure corresponds to enAttrID. CNcomment:指针类型，VOIP 通道子属性，结构体与enAttrID 对应。
 \retval ::0 Success CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA   The input parameter is invalid. CNcomment:无效的输入参数
 \retval ::HI_ERR_VOIP_HME_NULL_PTR  The pointer is null. CNcomment:空指针
 \retval ::Other values  Channel attributes fail to be obtained. CNcomment:其它  获取通道属性失败
...
/**
 \brief Modifies the sub attributes of a VoIP channel. CNcomment:修改VOIP 通道子属性
 \attention \n
 \param[in] hVoip  VoIP channel handle CNcomment:VOIP 通道句柄
 \param[in] enAttrID  ID of the VoIP channel configuration parameter. For details, see :HI_UNF_VOIP_ATTR_ID_E. CNcomment:VOIP 通道配置参数ID，参见: HI_UNF_VOIP_ATTR_ID_E
 \param[out] pChSubAttr  Pointer to the sub attributes of a VoIP channel. The data structure corresponds to enAttrID. CNcomment:指针类型，VOIP 通道子属性，结构体与enAttrID 对应。
...
/**
 \brief Plays the ringback tone. CNcomment:播放回铃音
 \attention \n
 \param[in] hVoip  VoIP channel handle CNcomment:VOIP 通道句柄
 \param[in] pstToneAttr  Pointer to the ringback tone playing parameter. For details, see :HI_UNF_VOIP_PLAY_TONE_ATTR_S. CNcomment:指针类型，回铃音播放参数，参见: HI_UNF_VOIP_PLAY_TONE_ATTR_S
 \retval ::0 Success CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA   The input parameter is invalid. CNcomment:无效的输入参数
 \retval ::HI_ERR_VOIP_HME_NULL_PTR  The pointer is null. CNcomment:空指针
 \retval ::Other values  The ringback tone fails to be played. CNcomment:其它  播放回铃音失败
 \see \n
N/A
 */
...
/**
 \brief Stops playing the ringback tone. CNcomment:停止播放回铃音
 \attention \n
 \param[in] hVoip  VoIP channel handle CNcomment:VOIP 通道句柄
 \retval ::0 Success CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA   The input parameter is invalid. CNcomment:无效的输入参数
 \retval ::Other values  The ringback tone fails to be stopped. CNcomment:其它  停止播放回铃音失败
 \see \n
N/A
 */
...
/**
 \brief Plays an audio file. CNcomment:播放音频文件
 \attention \n
        Only the standard WAV file of the 711 payload type is supported. CNcomment:目前只支持播放711类型的标准wav文件，且文件为纯净荷。
 \param[in] hVoip  VoIP channel handle CNcomment:VOIP 通道句柄
 \param[in] pstAnnAttr  Pointer to the audio file playing parameter. For details, see :HI_UNF_VOIP_PLAY_ANNOUNCEMENT_ATTR_S. 
                        CNcomment:指针类型，音频文件播放参数，参见: HI_UNF_VOIP_PLAY_ANNOUNCEMENT_ATTR_S
 \retval ::0 Success CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA   The input parameter is invalid. CNcomment:无效的输入参数
 \retval ::HI_ERR_VOIP_HME_NULL_PTR  The pointer is null. CNcomment:空指针
 \retval ::Other values  The audio file fails to be played. CNcomment:其它  播放音频文件失败
 \see \n
N/A
 */
...
/**
 \brief Stops playing an audio file. CNcomment:停止播放音频文件
 \attention \n
 \param[in] hVoip  VoIP channel handle CNcomment:VOIP 通道句柄
 \param[in] u32Direction  Playing direction. It must be the same as the value of u32Direction (audio file playing attribute). 
            CNcomment:播放方向，必须与音频文件播放属性中的u32Direction 保持一致。
 \retval ::0 Success CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA   The input parameter is invalid. CNcomment:无效的输入参数
 \retval ::Other values  The audio file fails to be stopped. CNcomment:其它  停止 播放音频文件失败
 \see \n
N/A
 */
...
/**
 \brief  Defines the type of the event callback function. CNcomment:定义事件回调函数类型
 \attention \n
N/A
 \param[in] hVoip  VoIP channel handle CNcomment:VOIP 通道句柄
 \param[in] enEvent     Event type enumeration. For details, see the definition of :HI_UNF_VOIP_EVENT_E . CNcomment:枚举类型，表示事件类型，参见: HI_UNF_VOIP_EVENT_E 定义
 \param[in] s32EventValue  Event type parameter. It can be used to add output parameters to events, for example, adding the error codes to error events.
                           CNcomment:事件类型参数，用于为event附带一些输出参数， 比如错误事件的错误码
 \param[in] u32Args        Transferred args parameter during registration CNcomment:注册时传入的args参数。
 \retval ::0 Success CNcomment:成功
 \retval ::Other values   Failure CNcomment:其它  失败
 \see \n
N/A
 */
...
N/A
 ...
 \param[in] pfnEventCB  Pointer to the callback function corresponding to the registered event. The null pointer indicates unregistration.
                        CNcomment:回调函数指针，指向与注册事件对应的回调函数。指针为NULL表示UnRegister
 \param[in] u32Args     Private parameter of a callback function. This parameter is transferred to the callback function when the callback function is called.
                        CNcomment:回调函数私有参数，此参数在回调函数被调用的时候会传递给回调函数。
 \retval ::0 Success CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA   The input parameter is invalid. CNcomment:无效的输入参数
 \retval ::HI_ERR_VOIP_HME_NOT_EXIST   The channel does not exist. CNcomment:通道不存在
 \see \n
N/A
 */
...
/**
 \brief Obtains the RTCP statistics. CNcomment:获取RTCP统计信息
 \attention \n
 \param[in] hVoip  VoIP channel handle CNcomment:VOIP 通道句柄
 \param[out] pstRtcpInfo  Pointer to RTCP statistics. For details, see :HI_UNF_VOIP_RTCP_STATIC_INFO_S. CNcomment:指针类型，RTCP统计信息，参见: HI_UNF_VOIP_RTCP_STATIC_INFO_S
 \retval ::0 Success CNcomment:
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA   The input parameter is invalid. CNcomment:无效的输入参数
 \retval ::HI_ERR_VOIP_HME_NULL_PTR  The pointer is null. CNcomment:空指针
 \retval ::Other values  The RTCP statistics fail to be obtained. CNcomment:其它  获取RTCP统计信息失败
 \see \n
N/A
 */
...
/**
 \brief  Performs the RTCP configuration. CNcomment:RTCP配置
 \attention \n
 \param[in] hVoip  VoIP channel handle CNcomment:VOIP 通道句柄
 \param[in] pstRtcpAttr  Pointer to RTCP configuration. For details, see :HI_UNF_VOIP_CFG_RTCP_ATTR_S. CNcomment:指针类型，RTCP配置，参见: HI_UNF_VOIP_CFG_RTCP_ATTR_S
 \retval ::0 Success CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA   The input parameter is invalid. CNcomment:无效的输入参数
 \retval ::HI_ERR_VOIP_HME_NULL_PTR  The pointer is null. CNcomment:空指针
 \retval ::Other values   RTCP configuration fails to be performed. CNcomment:其它  RTCP配置失败
 \see \n
N/A
 */
...
/**
 \brief Initializes the VoIP audio adapter module. CNcomment:初始化音频适配模块
 \attention \n
You must initialize the VoIP module before initializing the audio adapter module. CNcomment:必须先初始化VOIP模块再初始化音频适配模块
 \param N/A
 \retval ::0  HI_SUCCESS CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_DEV_OPEN_ERR Failed to open the device. CNcomment:打开设备节点失败
 \retval ::HI_ERR_VOIP_HME_DEV_NOT_EXIST The device do not exist. CNcomment:设备不存在
 \retval ::HI_ERR_VOIP_HME_NOT_DEV_FILE It is not device file. CNcomment:不是设备文件
 \retval ::Other values    Failure CNcomment:其它  失败
 \see \n
None
 */
...
/**
 \brief Deinitializes the VoIP audio adapter module. CNcomment:音频适配模块去初始化
 \attention \n
You are advised to deinitialize the audio adapter module after deinitializing the VoIP module. CNcomment:去初始化音频适配模块之前需去初始化VOIP模块。
 \param N/A
 \retval ::0  HI_SUCCESS CNcomment:成功
 \see \n
None
...
/**
 \brief Starts the audio device. CNcomment:打开音频设备
 \attention \n
You are advised to start the audio device immediately after initializing the audio adapter module. CNcomment:打开音频设备之前需初始化音频适配模块。
 \param[in] pstAudDev   Parameters of the started audio device CNcomment:音频设备参数
 \param[in] stAudDevOptFlag  Operated object flag CNcomment:音频设备操作标志
 \retval ::0  HI_SUCCESS CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_NO_INIT  No Deinitialization CNcomment:未初始化
 \retval ::HI_ERR_VOIP_HME_NULL_PTR  The point is null. CNcomment:空指针
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA The parameter is invalid. CNcomment:无效参数
 \see \n
N/A
 */
...
/**
 \brief Stops the audio device. CNcomment:关闭音频设备
 \attention \n
 N/A
 \param[in] s32AudioDevIndex   ID of the aduio device CNcomment:音频设备ID, 请参考 HI_UNF_VOIP_AUDIO_DEVICE_E 定义
 \param[in] stAudDevOptFlag  Operated object flag CNcomment:音频设备操作标志
 \retval ::0  HI_SUCCESS CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_NO_INIT  No Deinitialization CNcomment:未初始化
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA  The parameter is invalid. CNcomment:无效参数
...
/**
 \brief Starts to transmit audio data. CNcomment:开始音频数据传输
 \attention \n
 N/A
 \param[in] s32AudioDevIndex   ID of the aduio device CNcomment:音频设备ID, 请参考 HI_UNF_VOIP_AUDIO_DEVICE_E 定义
 \param[in] stAudDevOptFlag  Operated object flag CNcomment:音频设备操作标志
...
/**
 \brief Stops transmitting audio data. CNcomment:停止音频数据传输
 \attention \n
 N/A
 \param[in] s32AudioDevIndex   ID of the aduio device CNcomment:音频设备ID, 请参考 HI_UNF_VOIP_AUDIO_DEVICE_E 定义
 \param[in] stAudDevOptFlag  Operated object flag CNcomment:音频设备操作标志
...
/**
 \brief Obtains the audio device status. CNcomment:获取音频设备状态
 \attention \n
 N/A
 \param[in] s32AudioDevIndex   ID of the aduio device CNcomment:音频设备ID, 请参考 HI_UNF_VOIP_AUDIO_DEVICE_E 定义
 \param[in] bAudioInDev  HI_TRUE for AI device, HI_FALSE for AO device CNcomment:音频设备输入输出类型
 \param[out] ps32Status  Returned audio device status CNcomment:音频设备状态
 \retval ::0  HI_SUCCESS CNcomment:成功 
 \retval ::HI_ERR_VOIP_HME_NO_INIT  No Deinitialization CNcomment:未初始化
 \retval ::HI_ERR_VOIP_HME_NULL_PTR  The point is null. CNcomment:空指针
 \retval ::HI_ERR_VOIP_HME_INVALID_PARA  The parameter is invalid. CNcomment:无效参数
...
/**
 \brief Defines the event callback function of the audio adapter. CNcomment:定义音频适配事件回调函数
 \attention \n
 N/A
 \param[in] pstAudadpEvent   Event structure CNcomment:音频适配事件属性结构体
 \retval ::0  HI_SUCCESS CNcomment:成功
 \retval ::others FAILURE CNcomment:其它 失败
 \see \n
N/A
 */    
...
/**
 \brief Registers the callback function for audio adapter events. CNcomment:注册音频适配模块事件回调函数 
 \attention \n
 N/A
 \param[in] pfnEventCB   Pointer of the callback function. Null pointer indicates unregisteration. CNcomment:事件回调函数指针 , NULL 用于注销事件回调函数.
 \param[in] u32Args  Private parameter from user application. CNcomment:用户私有数据.
 \retval ::0  HI_SUCCESS CNcomment:成功
 \retval ::HI_ERR_VOIP_HME_NO_INIT   No Deinitialization CNcomment:未初始化
 \see \n
N/A
...
/**
 \brief Obtain ALSA audio device list. CNcomment:获取ALSA音频设备列表 
 \attention \n
 \param[in] enAudioDevType  The input and output type of audio device. CNcomment:音频设备输入输出类型
 \param[in] pstCardList   The point of ALSA audio device list. CNcomment:ALSA音频设备列表指针
 \param[in] u32Max        The maximum device number of ALSA audio device list. CNcomment:ALSA音频设备列表最大设备数目
 \param[out] pu32Count    Obtained number of audio device CNcomment:获取到的音频设备数目
 \retval ::HI_SUCCESS  Success CNcomment:成功
 \retval ::Other Failure CNcomment:其它 失败
 \see \n
N/A
 */
...
/** 
 \brief Obtain sample rate range of audio device. CNcomment:获取音频设备采样率范围
 \attention \n
 Audio device must be in closed status. CNcomment:音频设备必须处于关闭状态.
 \param[in] pstCardInfo  The information of ALSA audio device CNcomment:ALSA音频设备信息
 \param[out] pu32Min     The minimum sample rate of audio device CNcomment:音频设备最小采样率
 \param[out] pu32Max     The maximum sample rate of audio device CNcomment:音频设备最大采样率
 \retval ::HI_SUCCESS  Success CNcomment:成功
 \retval ::Other Failure CNcomment:其它 失败
 \see \n
N/A
