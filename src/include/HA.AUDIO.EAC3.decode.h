 ...
 ******************************************************************************
 ...
 History       :
******************************************************************************/
#ifndef __HISI_AUDIO_DECODER_EAC3_H__
#define __HISI_AUDIO_DECODER_EAC3_H__
...
#define    HA_EAC3_ID 0x0015      
#define    HA_AUDIO_ID_EAC3   HA_BUILD_CODEC_ID(VENDOR_NONE,FORMAT_EAC3,HA_EAC3_ID)  /**< support FORMAT_EAC3 */

#define HA_EAC3_DecGetDefalutOpenParam(pOpenParam) \
do{ HI_S32 i; \
...
#endif /* __HISI_AUDIO_DECODER_EAC3_H__ */
