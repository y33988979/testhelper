...
do {                                                                            \
    ...
    {                                                                           \
        printf("    key:%-16s value:", _pstMeta->pstKvp[i].pszKey);             \
        _s32ValLen = _pstMeta->pstKvp[i].u32ValueNum;                           \
        switch (_pstMeta->pstKvp[i].eValueType)                                 \
        {                                                                       \
        case HI_SVR_PLAYER_VALUE_U8:                                            \
            printf("0x%x", _pstMeta->pstKvp[i].unValue.u8Value);                \
            break;                                                              \
        case HI_SVR_PLAYER_VALUE_U8P:                                           \
            for (j = 0; j < _s32ValLen; j++)                                    \
                printf("0x%x ", _pstMeta->pstKvp[i].unValue.pu8Value[j]);       \
            break;                                                              \
        case HI_SVR_PLAYER_VALUE_CHAR:                                          \
            printf(":%c", _pstMeta->pstKvp[i].unValue.cValue);                  \
            break;                                                              \
        case HI_SVR_PLAYER_VALUE_CHARP:                                         \
            printf("%s", _pstMeta->pstKvp[i].unValue.pszValue);                 \
            break;                                                              \
        case HI_SVR_PLAYER_VALUE_S32:                                           \
            printf("%d", _pstMeta->pstKvp[i].unValue.s32Value);                 \
            break;                                                              \
        case HI_SVR_PLAYER_VALUE_S32P:                                          \
            for (j = 0; j < _s32ValLen; j++)                                    \
                printf("%d ", _pstMeta->pstKvp[i].unValue.ps32Value[j]);        \
            break;                                                              \
        case HI_SVR_PLAYER_VALUE_S64:                                           \
            printf("%lld ", _pstMeta->pstKvp[i].unValue.s64Value);              \
            break;                                                              \
        case HI_SVR_PLAYER_VALUE_S64P:                                          \
            for (j = 0; j < _s32ValLen; j++)                                    \
                printf("%lld ", _pstMeta->pstKvp[i].unValue.ps64Value[j]);      \
            break;                                                              \
         default:                                                               \
            printf("Unkown type!\n");                                           \
            break;                                                              \
...
/**
\brief Creates a metadata data structure.CNcomment:创建Metadata结构体
\attention \n
None.
\param None
\retval Pointer to the ::HI_SVR_PLAYER_METADATA_S data structure. CNcomment: ::HI_SVR_PLAYER_METADATA_S结构体指针
\see \n
None.
*/

inline HI_SVR_PLAYER_METADATA_S *HI_SVR_META_Create()
{
...
/**
\brief Releases the metadata data structure. CNcomment:释放Metadata结构体
\attention \n
None.
\param None
\retval None.
...
inline HI_VOID HI_SVR_META_Free(HI_SVR_PLAYER_METADATA_S ** ppstMetadata)
{
    HI_SVR_PLAYER_METADATA_S *pstMetadata = NULL;
