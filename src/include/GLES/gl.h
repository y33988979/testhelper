...
/* $Revision: 1.9.12.2.20.2 $ on $Date: 2011/11/24 02:09:15 $ */
...
GL_API void GL_APIENTRY glTexDirectVIV (GLenum Target, GLsizei Width, GLsizei Height, GLenum Format, GLvoid ** Pixels, GLuint Address[3]);
