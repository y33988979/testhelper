 ...
 ******************************************************************************
 ...
 History       :
******************************************************************************/
#ifndef __HISI_AUDIO_DECODER_AC3_H__
#define __HISI_AUDIO_DECODER_AC3_H__
...
#define    HA_AC3_ID 0x004        
#define    HA_AUDIO_ID_AC3   HA_BUILD_CODEC_ID(VENDOR_NONE,FORMAT_AC3,HA_AC3_ID)  /**< support FORMAT_AC3 */

#define HA_AC3_DecGetDefalutOpenParam(pOpenParam) \
do{ HI_S32 i; \
...
#define HA_AC3_DecSetMode(pOpenParam, eDecMode) \
...
#endif /* __HISI_AUDIO_DECODER_AC3_H__ */
