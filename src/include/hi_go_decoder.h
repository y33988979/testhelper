...
/**
\brief Decodes a specified file, and generates a new surface.CNcomment:解码指定的文件，并生成一个新的surface
\attention \n
    ...
    JPEG只解主图，GIF解码解码第一张图片surface的大小与图片的大小一致
\param[in] pszFile Picture name. The picture can be in the format of .gif, .png, .jpg, or .bmp.CNcomment:图片文件名，可以是GIF, PNG, JPG, BMP
\param[out] pSurface, Surface for storing decoded pictures.CNcomment:保存解码后图像 
