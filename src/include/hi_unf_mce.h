...
/**
\brief  clear boot logo  CNcomment:清空开机logo
\attention \n
this use to clear boot logo when  noly boot logo change to video 
CNcomment: 只有烧开机logo 的情况下，启动应用视频前，先清空开机logo
\param N/A
\retval ::HI_SUCCESS 
\retval ::HI_FAILURE 
\see \n
...
/**
\brief  stop fastplay and destrory fastplay source CNcomment:停止fastplay,销毁fastplay资源
\attention \n
...
/**
\brief  get current fastplay status  CNcomment:得到当前FastPlay播放状态
\attention \n
\param[out]  pPlayCurStatus current fastplay status.  CNcomment:Fastplay当前的播放状态
\retval ::HI_SUCCESS 
\retval :: HI_FAILURE   			Failure
\see \n
N/A
...
/** 
\brief init mce  CNcomment:MCE配置初始化接口
\attention \n
Initializes the media control engine (MCE) for preparing other operations.
CNcomment:使用MCE配置工作首先调用该接口
\param[in] PartType  Part to be operated.  CNcomment:该配置涉及到的分区
\retval ::HI_SUCCESS   Success  CNcomment:成功
\retval ::HI_ERR_MCE_OPEN_ALREADY  The MCE is already opened.  CNcomment:设备已经打开
\retval ::HI_ERR_MCE_PARAM_INVALID The parameter is invalid.  CNcomment:参数错误
\retval ::HI_ERR_MCE_MTD_NOFIND    This part does not exist. CNcomment:没有默认分区
\retval ::HI_ERR_MCE_MTD_INFO      The size is insufficient for loading data. CNcomment:实际分区尺寸不满足配置涉及的大小
\see \n
N/A
*/
...
/** 
\brief deinit mce  CNcomment:MCE配置去初始化接口
\attention \n
Destroys all MCE resources.  CNcomment:完成MCE配置工作最终调用该接口
\param N/A
\retval N/A
\see \n
N/A
...
/** 
\brief Obtains the basic configuration information.  CNcomment:获取BASE配置区信息
\attention \n
N/A
\param[in] baseParam   Pointer to the basic parameters.  CNcomment:参数指针
\retval ::HI_SUCCESS    Success  CNcomment:成功
\retval ::HI_ERR_MCE_PTR_NULL      The pointer is null.  CNcomment:参数指针NULL
\retval ::HI_ERR_MCE_MTD_NOFIND    This part does not exist.  CNcomment:没有该分区
\retval ::HI_ERR_MCE_MTD_OPEN      The open operation fails. CNcomment:分区打开错误
\retval ::HI_ERR_MCE_MTD_READ      The read operation fails. CNcomment:分区读取错误
\retval ::HI_ERR_MCE_BASE_INFO     Get information fails. CNcomment:由分区中获取信息错误
\retval ::HI_ERR_MCE_MTD_CLOSE     The close operation fails. CNcomment:分区关闭错误
\see \n
N/A
*/
...
/** 
\brief Modifies the basic configuration information.  CNcomment:更新BASE配置区信息
\attention \n
N/A
\param[in] baseParam    Pointer to the basic parameters.  CNcomment:参数指针
\retval ::HI_SUCCESS   Success  CNcomment:成功
\retval ::HI_ERR_MCE_PTR_NULL      The pointer is null. CNcomment:参数指针NULL
\retval ::HI_ERR_MCE_MTD_NOFIND    This part does not exist. CNcomment:没有该分区
\retval ::HI_ERR_MCE_BASE_INFO     The config information is error.  CNcomment:配置信息错误
\retval ::HI_ERR_MCE_MTD_OPEN      The open operation fails. CNcomment:分区打开错误
\retval ::HI_ERR_MCE_MTD_WRITE     The write operation fails. CNcomment:分区写入错误
\retval ::HI_ERR_MCE_MTD_CLOSE     The close operation fails. CNcomment:分区关闭错误
\see \n
N/A
*/
...
CNcomment:获取LOGO配置区信息
\attention \n
N/A
\param[in] logoParam   Pointer to the logo parameter.  CNcomment:参数指针
\retval ::HI_SUCCESS   Success  CNcomment:成功
\retval ::HI_ERR_MCE_PTR_NULL      The pointer is null.  CNcomment:参数指针NULL
\retval ::HI_ERR_MCE_MTD_NOFIND    This part does not exist. CNcomment:没有该分区
\retval ::HI_ERR_MCE_MTD_OPEN      The open operation fails.  CNcomment:分区打开错误
\retval ::HI_ERR_MCE_MTD_READ      The read operation fails.  CNcomment:分区读取错误
\retval ::HI_ERR_MCE_LOGO_INFO     Get information from partition error. CNcomment:由分区中获取信息错误
\retval ::HI_ERR_MCE_MTD_CLOSE     The close operation fails. CNcomment:分区关闭错误
\see \n
N/A
*/
...
/** 
\brief Modifies the configuration of the logo parameter.  CNcomment:更新LOGO配置区信息
\attention \n
Update logo parameter, you must invoke this function befor update data of logo
\CNcomment:更新logo参数，在更新logo内容前必须先调用此函数
\param[in] logoParam   Pointer to the logo parameter  CNcomment:参数指针
\retval ::HI_SUCCESS   Success  CNcomment:成功
\retval ::HI_ERR_MCE_PTR_NULL      The pointer is null.  CNcomment:参数指针NULL
\retval ::HI_ERR_MCE_MTD_NOFIND    This part does not exist.  CNcomment:没有该分区
\retval ::HI_ERR_MCE_LOGO_INFO     The config infogmation is error.  CNcomment:配置信息错误
\retval ::HI_ERR_MCE_MTD_OPEN      The open operation fails. CNcomment:分区打开错误
\retval ::HI_ERR_MCE_MTD_WRITE     The write operation fails. CNcomment:分区写入错误
\retval ::HI_ERR_MCE_MTD_CLOSE     The close operation fails. CNcomment:分区关闭错误
\see \n
...
/** 
\brief Obtains the logo data from the flash memory. CNcomment:获取LOGO内容区信息
\attention \n
N/A
\param[in] content Pointer to the logo data that is written from the flash memory. CNcomment:内容buf指针
\param[in] size    Size of the logo data to be written.  CNcomment:内容长度
\retval ::HI_SUCCESS  Success CNcomment:成功
\retval ::HI_ERR_MCE_PTR_NULL      The pointer is null. CNcomment:参数指针NULL
\retval ::HI_ERR_MCE_MTD_NOFIND    This part does not exist. CNcomment:没有该分区
\retval ::HI_ERR_MCE_PARAM_INVALID The parameter is invalid. CNcomment:参数无效
\retval ::HI_ERR_MCE_MTD_OPEN      The open operation fails. CNcomment:分区打开错误
\retval ::HI_ERR_MCE_MTD_READ      The read operation fails. CNcomment:分区读取错误
\retval ::HI_ERR_MCE_MTD_CLOSE     The close operation fails. CNcomment:分区关闭错误
\see \n
...
/** 
\brief Modifies the logo data.  CNcomment:更新LOGO内容区信息
\attention \n
...
\CNcomment:更新logo内容，在此函数之前必须先调用HI_UNF_MCE_UpdateLogoParam函数更新logo参数
\param[in] content  Pointer to the logo data that is read from the flash memory  CNcomment:内容buf指针
\param[in] size     Size of the logo data to be read  CNcomment:内容长度
\retval ::HI_SUCCESS   Success  CNcomment:成功
\retval ::HI_ERR_MCE_PTR_NULL      The pointer is null.  CNcomment:参数指针NULL
\retval ::HI_ERR_MCE_MTD_NOFIND    This part does not exist.  CNcomment:没有该分区
\retval ::HI_ERR_MCE_PARAM_INVALID The parameter is invalid.  CNcomment:参数无效
...
/** 
\brief Obtains the playing configuration information.  CNcomment:获取PLAY配置区信息
\attention \n
N/A
\param[in]  playParam   Playing configuration information  CNcomment:参数指针
\retval ::HI_SUCCESS   Success  CNcomment:成功
\retval ::HI_ERR_MCE_PTR_NULL      The pointer is null.  CNcomment:参数指针NULL
\retval ::HI_ERR_MCE_MTD_NOFIND    This part does not exist.  CNcomment:没有该分区
\retval ::HI_ERR_MCE_MTD_OPEN      The open operation fails. CNcomment:分区打开错误
\retval ::HI_ERR_MCE_MTD_READ      The read operation fails. CNcomment:分区读取错误
\retval ::HI_ERR_MCE_PLAY_INFO     Get information fails.  CNcomment:由分区中获取信息错误
\retval ::HI_ERR_MCE_MTD_CLOSE     The close operation fails.  CNcomment:分区关闭错误
\see \n
N/A
*/
...
/** 
\brief   Modifies the playing configuration information.  CNcomment:更新PLAY配置区信息
\attention \n 
Update play parameter, you must invoke this function befor update data of play
\CNcomment:更新play参数，在更新play内容前必须先调用此函数
\param[in]  playParam  Playing configuration information  CNcomment:参数指针
\retval ::HI_SUCCESS    Success  CNcomment:成功
\retval ::HI_ERR_MCE_PTR_NULL      The pointer is null. CNcomment:参数指针NULL
\retval ::HI_ERR_MCE_MTD_NOFIND    This part does not exist. CNcomment:没有该分区
\retval ::HI_ERR_MCE_PLAY_INFO     The config information is invalid. CNcomment:配置信息错误
\retval ::HI_ERR_MCE_MTD_OPEN      The open operation fails. CNcomment:分区打开错误
\retval ::HI_ERR_MCE_MTD_WRITE     The write operation fails. CNcomment:分区写入错误
\retval ::HI_ERR_MCE_MTD_CLOSE     The close operation fails. CNcomment:分区关闭错误
\see \n
...
/** 
\brief Obtains the data being playing from the flash memory.  CNcomment:获取PLAY内容区信息
\attention \n
N/A
\param[in] content  Pointer to the data that is read from the flash memory  CNcomment:内容buf指针
\param[in] size     Size of the data being played that is read from the flash memory  CNcomment:内容长度
\retval ::HI_SUCCESS   Success  CNcomment:成功
\retval ::HI_ERR_MCE_PTR_NULL      The pointer is null. CNcomment:参数指针NULL
\retval ::HI_ERR_MCE_MTD_NOFIND    This part does not exist. CNcomment:没有该分区
\retval ::HI_ERR_MCE_PARAM_INVALID  The parameter is invalid. CNcomment:参数无效
...
/** 
\brief Updates the playing data part. CNcomment:更新PLAY内容区信息
\attention \n
...
\CNcomment:更新play内容，在此函数之前必须先调用HI_UNF_MCE_UpdatePlayParam函数更新play参数
\param[in] content  Pointer to the data that is written to the flash memroy.  CNcomment:内容buf指针
\param[in] size    Size of the data being played.  CNcomment:内容长度
\retval ::HI_SUCCESS   Success  CNcomment:成功
\retval ::HI_ERR_MCE_PTR_NULL      The pointer is null. CNcomment:参数指针NULL
\retval ::HI_ERR_MCE_MTD_NOFIND    This part does not exist. CNcomment:没有该分区
\retval ::HI_ERR_MCE_PARAM_INVALID The parameter is invalid. CNcomment:参数无效
...
/** 
\brief  Enables or disables the logo.  CNcomment:打开或者关闭logo
\attention \n
N/A
\param[in] bLogoOpen whether to enable Logo. CNcomment:bLogoOpen设置为HI_TRUE为开logo，HI_FALSE为关闭logo
\retval ::HI_SUCCESS   Success  CNcomment:成功
\retval ::HI_ERR_MCE_PTR_NULL      The pointer is null. CNcomment:参数指针NULL
\retval ::HI_ERR_MCE_MTD_NOFIND    This part does not exist. CNcomment:没有该分区
\retval ::HI_ERR_MCE_PARAM_INVALID The parameter is invalid. CNcomment:参数无效
...
/** 
\brief Starts or stops playing. CNcomment:打开或者关闭Fastplay
\attention \n
N/A
\param[in] bPlayOpen  whether to enable Fastplay.  CNcomment:bLogoOpen设置为HI_TRUE为开Fastplay，HI_FALSE为关闭Fastplay
\retval ::HI_SUCCESS  Success  CNcomment:成功
\retval ::HI_ERR_MCE_PTR_NULL      The pointer is null.  CNcomment:参数指针NULL
\retval ::HI_ERR_MCE_MTD_NOFIND    This part does not exist.  CNcomment:没有该分区
\retval ::HI_ERR_MCE_PARAM_INVALID The parameter is invalid.  CNcomment:参数无效
...
/** 
\brief  Obtains the status of the logo.  CNcomment:获取logo的打开或者关闭Flag
\attention \n
N/A
\param[out] pbLogoOpenFlag indicating the status of the logo.  CNcomment:获取logo的(打开或关闭)Flag的指针
...
/** 
\brief Obtains the playing status.  CNcomment:获取Fastplay的打开或者关闭Flag
\attention \n
N/A

\param[out] pbPlayOpen      Flag indicating the playing status.  CNcomment:获取Fastplay的(打开或关闭)Flag的指针
