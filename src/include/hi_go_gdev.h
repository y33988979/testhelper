...
\param[in] pstScrollAttr       滚动字幕属性
\param[out] phScrollText  滚动字幕的输出句柄
...
\param[in] hScrollText       滚动字幕的句柄
\param[out] pstScrollData  滚动字幕的数据信息
...
/**
\brief Sets the canvas buffer of a graphics layer. CNcomment:设置层的canvas surface.
\attention \n
...
\param[in] Layer     Layer handle. CNcomment:图层句柄
\param[in] hSurface  Surface of a graphics layer. If the value is INVALID_HANDLE, there is no user handle. CNcomment:图层的surface，如果该参数为INVALID_HANDLE表示没有用户句柄
...
/**
\brief Obtains the background color of a graphics layer. CNcomment:获取图层的背景颜色
\attention \n
...
CNcomment:此接口只有在图层上有窗口的时候才会有效。否则该颜色设置无效。
\param[in] Layer Layer handle. CNcomment:图层句柄
\param[in] pColor Used for storing the background color of a graphics layer. CNcomment:存储图层背景颜色
...
/**
\brief Sets the size of a display buffer. CNcomment:设置显示buffer size
\attention \n
无

\param[in] Layer      Layer handle. CNcomment:图层句柄
\param[in] u32DWidth     Pointer to the width. CNcomment:宽度指针
\param[in] u32DHeight    Pointer to the height. CNcomment:高度指针
...
/**
\brief Obtains the size of a display buffer. CNcomment:获取显示buffer的size
\attention \n
无

\param[in] Layer      Layer handle. CNcomment:图层句柄
\param[in] pDWidth    Pointer to the width. The value cannot be empty. CNcomment:宽度指针，不可为空 
\param[in] pDHeight   Pointer to the height. The value cannot be empty. CNcomment:高度指针，不可为空
\param[out] 无 
...
/**
\brief Sets the refresh mode. CNcomment:设置刷新类型
\attention \n
无

\param[in] Layer         Layer handle. CNcomment:图层句柄           
\param[in] FlushType     Refresh mode of a graphics layer. CNcomment:图层刷新类型
\param[out] N/A. CNcomment:无
...
/**
\brief Obtains the refresh mode. CNcomment:获取刷新类型
\attention \n
无

\param[in] Layer       Layer handle. CNcomment:图层句柄              
\param[in] *pFlushType Refresh mode of a graphics layer. The value cannot be empty. CNcomment:图层刷新类型，不可为空 
\param[out] N/A. CNcomment:无 
...
/**
\brief Sets the palette of a graphics layer. CNcomment:设置图层的调色板
\attention \n
无

\param[in] Layer       Layer handle. CNcomment:图层句柄              
\param[in] Palette     Palette of a graphics layer. CNcomment:图层调色板
\param[out] N/A. CNcomment:无 
...
/**
\brief Obtains the palette of a graphics layer. CNcomment:获取图层调色板
\attention \n
N/A
...
/**
\brief Waits for the blanking area. CNcomment:等待消隐区
\attention \n
N/A
...
/**
\brief Sets frame encode mode of a graphic layer. CNcomment:设置图层帧传输格式
\attention \n
MONO is the default mode.HIGO_ENCPICFRM_STEREO_TOPANDBOTTOM is not supported when
stereo mode is HIGO_STEREO_MODE_HW_FULL.
CNcomment:默认为MONO格式，即普通非3D Stereo格式
其中HIGO_STEREO_MODE_HW_FULL不支持HIGO_ENCPICFRM_STEREO_TOPANDBOTTOM

\param[in] Layer       Layer handle. CNcomment:图层句柄              
\param[in] EncPicFrm  Frame encode mode.The value cannot be empty. CNcomment:图层帧传输编码格式，不可为空   
...
/**
\brief Obtains frame encode mode of a graphic layer. CNcomment:获取图层帧传输格式
\attention \n
无

\param[in] Layer       Layer handle. CNcomment:图层句柄              
\param[out] pEncPicFrm  Frame encode mode.The value cannot be empty. CNcomment:图层帧传输编码格式，不可为空   
...
/**
\brief Sets stereo mode of a graphics layer. CNcomment:设置3D Stereo的模式
\attention \n
HIGO_ENCPICFRM_STEREO_TOPANDBOTTOM is not supported when stereo mode is HIGO_STEREO_MODE_HW_FULL.
CNcomment:其中HIGO_STEREO_MODE_HW_FULL不支持HIGO_ENCPICFRM_STEREO_TOPANDBOTTOM

\param[in] Layer       Layer handle. CNcomment:图层句柄              
\param[in] StereoMode  Stereo mode, the value cannot be empty. CNcomment:3d stereo模式，不可为空
...
/**
\brief Sets stereo mode of a graphics layer. CNcomment:获取3D Stereo的模式
\attention \n
无

\param[in] Layer       Layer handle. CNcomment:图层句柄              
\param[out] pStereoMode  Stereo mode, the value cannot be empty. CNcomment:3d stereo模式，不可为空   
...
/**
\brief Sets compress mode of a graphic layer. CNcomment:设置使能压缩模式
\attention \n
When compress is enable, only HIGO_PF_8888 is supported;SD layer and  STEREO TOPANDBOTTOM
are also not supported.
CNcomment:只支持像素格式为HIGO_PF_8888，不支持标清和3D STEREO TOPANDBOTTOM模式

\param[in] Layer       Layer handle. CNcomment:图层句柄              
\param[in] StereoMode  Stereo mode, the value cannot be empty. CNcomment:压缩使能，不可为空
...
/**
\brief Sets compress mode of a graphic layer. CNcomment:获取压缩模式是否使能
\attention \n
无

\param[in] Layer       Layer handle. CNcomment:图层句柄              
\param[out] pbEnable  Stereo mode, the value cannot be empty. CNcomment:压缩使能，不可为空   
