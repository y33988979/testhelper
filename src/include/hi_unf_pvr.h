...
/**
 * \file
 * \brief Describes the information about the personal video recorder (PVR). CNcomment: 提供PVR的相关信息
 */
...
/**Maximum length of the encryption key, in byte. Note: The valid key length may not be the maximum length, and depends on the encryption algorithm.*//**CNcomment: 加密密钥最大长度，单位:字节。注意: 密钥的有效长度不一定是最大长度，而是由加密的算法决定 */
...
typedef struct hiUNF_PVR_REC_ATTR_S
{
    ...
    HI_UNF_VCODEC_TYPE_E        enIndexVidType;                        /**<Video encoding protocol with which the stream (for which an index is to be created) complies. The protocol (static attribute) needs to be set only when the index type is HI_UNF_PVR_REC_INDEX_TYPE_VIDEO.*//**<CNcomment: 待建立索引的码流的视频编码协议, 索引类型是HI_UNF_PVR_REC_INDEX_TYPE_VIDEO时才需要配置,静态属性  */
    ...
    HI_U64                      u64MaxTimeInMs;                        /**<Size of the file to be recorded, static attribute. If the value is 0, it indicates that there is no limit on the file size. The maximum file size is 5242880 bytes (5 MB). If the disk space is sufficient, it is recommended to set the file size to a value greater than 512 MB. The file size cannot be 0 in rewind mode. */
    HI_BOOL                     bRewind;                               /**<Whether to rewind, static attribute. If this item is set to HI_TRUE, the PVR rewinds to the file header to record streams after the recorded file size reaches u64MaxFileSize. If this item is set to HI_FALSE, the PVR stops recording after the recorded file size reaches u64MaxFileSize.*//**<CNcomment: 是否回绕，静态属性。如配置为HI_TRUE，录制文件大小到达u64MaxFileSize后，会回绕到文件头继续进行录制；如配置为HI_FALSE，则录制文件大小到达u64MaxFileSize后，会停止录制。*/
...
typedef enum hiUNF_PVR_PLAY_POS_TYPE_E
{
  ...
  HI_UNF_PVR_PLAY_POS_TYPE_FRAME,             /**<The playing position is expressed by the number of frames or PESs.*//**<CNcomment: 用帧数（或者PES数）表示位置  */
...
/**
\brief Initializes the PVR recording module. CNcomment:初始化PVR录制模块
\attention \n
...
\retval ::HI_FAILURE This API fails to be called due to system errors. CNcomment: 出现系统错误，API调用失败
\see \n
...
/**
\brief Deinitializes the PVR recording module. CNcomment: 去初始化PVR录制模块
\attention \n
...
\retval ::HI_SUCCESS Success  CNcomment:成功
\retval ::HI_FAILURE This API fails to be called due to system errors.CNcomment: 出现系统错误，API调用失败
\retval ::HI_ERR_PVR_BUSY  The PVR recording module is being used. CNcomment: 录制模块还在使用中
\retval ::HI_ERR_PVR_NOT_INIT  The PVR recording module is not initialized. CNcomment: 录制模块未初始化
\see \n
::HI_UNF_PVR_RecInit
*/
...
/**
\brief Creates a recording channel. CNcomment: 创建1路录制通道
\attention \n
...
\param[in] pu32ChnID   ID of the obtained recording channel  CNcomment: 获取到的录制通道ID
\param[in] pstRecAttr  Pointer to the attributes of a channel   CNcomment:指针类型，指向通道属性配置
\retval ::HI_SUCCESS  Success CNcomment:成功
\retval ::HI_ERR_PVR_NOT_INIT  The PVR recording module is not initialized.  CNcomment:录制模块未初始化
\retval ::HI_ERR_PVR_NUL_PTR The pointer is null. CNcomment: 指针参数为空
\retval ::HI_ERR_DMX_INVALID_PARA  The parameter is invalid.  CNcomment:  参数非法
\retval ::HI_ERR_PVR_FILE_INVALID_FNAME  The file name is invalid.  CNcomment:文件名参数非法
\retval ::HI_ERR_PVR_FILE_EXIST The file already exists.  CNcomment:文件已经存在
\retval ::HI_ERR_PVR_NO_CHN_LEFT  There is no available channel.   CNcomment:已经没有空闲的通道供分配
\retval ::HI_ERR_PVR_FILE_CANT_OPEN  The file cannot be opened.  CNcomment: 无法打开文件
\retval ::HI_ERR_PVR_INDEX_CANT_MKIDX  The index file cannot be opened.  CNcomment: 无法打开索引文件
\retval ::HI_ERR_PVR_REC_INVALID_DMXID The DEMUX ID received during recording is incorrect.  CNcomment: 录制时传入了错误的DEMUX ID
\see \n
N/A
*/
...
/**
\brief  Releases a specified recording channel. CNcomment: 释放指定的录制通道
\attention \n
...
\param[in] u32ChnID   ID of the channel to be released CNcomment: 需要释放的通道号
\retval ::HI_SUCCESS Success CNcomment: 成功
\retval ::HI_ERR_PVR_NOT_INIT  The PVR recording module is not initialized. CNcomment: PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID  The channel ID is invalid.  CNcomment: 通道号非法
\retval ::HI_ERR_PVR_BUSY  The current operation is forbidden because the channel is busy. CNcomment: 通道忙，不允许进行当前操作
\see \n 
N/A
*/
...
/**
\brief Sets the attributes of a recording channel. CNcomment: 设置录制通道属性
\attention \n
You can modify only the dynamic attributes by calling this API. 
CNcomment:只有动态属性才能用此接口改变设置
\param[in] u32ChnID   Channel ID CNcomment: 通道号
\param[in] pstRecAttr  Attribute to be set  CNcomment:待设置的属性
\retval ::HI_SUCCESS Success CNcomment: 成功
\retval ::HI_ERR_PVR_NOT_INIT  The PVR recording module is not initialized. CNcomment:PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID  The channel ID is invalid.  CNcomment: 通道号非法
\see \n
...
/**
\brief Obtains the attributes of a recording channel. CNcomment: 获取录制通道属性
\attention \n
N/A 
\param[in] u32ChnID   Channel ID CNcomment: 通道号
\param[in] pstRecAttr   Pointer to the obtained channel attributes   CNcomment:指针类型，指向获取到的通道属性配置
\retval ::HI_SUCCESS  Success  CNcomment:成功
\retval ::HI_ERR_PVR_NOT_INIT    The PVR recording module is not initialized.  CNcomment:PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID  The channel ID is invalid.  CNcomment: 通道号非法
\retval ::HI_ERR_PVR_NUL_PTR        The pointer is null.  CNcomment:指针参数为空
\retval ::HI_ERR_PVR_CHN_NOT_INIT  The specified channel is not initialized.   CNcomment:指定的通道未初始化
\see \n
N/A
*/
...
\retval ::HI_ERR_PVR_INVALID_CHNID    The channel ID is invalid.  CNcomment:通道号非法
\retval ::HI_ERR_PVR_CHN_NOT_INIT   The specified channel is not initialized.  CNcomment: 指定的通道未初始化
\retval ::HI_ERR_PVR_ALREADY       The specified channel has been started.  CNcomment: 指定的通道已经启动
\retval ::HI_FAILURE                 This API fails to be called due to system errors.  CNcomment:出现系统错误，API调用失败
\see \n
...
\retval ::HI_ERR_PVR_INVALID_CHNID     The channel ID is invalid.    CNcomment:通道号非法
\retval ::HI_ERR_PVR_CHN_NOT_INIT     The specified channel is not initialized. CNcomment:指定的通道未初始化
\retval ::HI_ERR_PVR_ALREADY         The specified channel has been stopped.    CNcomment:指定的通道已经停止
\retval ::HI_ERR_PVR_BUSY            The current operation is forbidden because the channel is busy. CNcomment:通道忙，不允许进行当前操作
\see \n
...
/**
\brief Pauses a recording channel. CNcomment: 暂停录制通道
\attention \n
It should be called under recording mode and can be repeated call.
CNcomment:只有录制状态调用该接口才有作用，允许重复调用
\param[in] u32ChnID   Channel ID  CNcomment:通道号
\retval ::HI_SUCCESS Success  CNcomment:成功  
\retval ::HI_ERR_PVR_REC_INVALID_STATE  PVR isn't playing or pausing. CNcomment: PVR非播放或者暂停状态
\see \n
...
/**
\brief Resumes a recording channel. CNcomment: 恢复录制通道
\attention \n
It should be called under recording mode and can be repeated call.
CNcomment:只有录制状态调用该接口才有作用，允许重复调用
\param[in] u32ChnID   Channel ID  CNcomment:通道号
\retval ::HI_SUCCESS Success  CNcomment:成功  
\retval ::HI_ERR_PVR_REC_INVALID_STATE  PVR isn't playing or paused.CNcomment: PVR非播放或者暂停状态
\see \n
...
/**
\brief Obtains the status of a recording channel.CNcomment:  获取录制通道状态
\attention \n
N/A  
\param[in] u32ChnID  Channel ID  CNcomment:通道号
\param[in] pstRecStatus   Pointer to the recording status   CNcomment:录制状态信息指针
\retval ::HI_SUCCESS Success  CNcomment: 成功
\retval ::HI_ERR_PVR_NOT_INIT    The PVR recording module is not initialized.  CNcomment:PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID   The channel ID is invalid.   CNcomment: 通道号非法
\retval ::HI_ERR_PVR_CHN_NOT_INIT    The specified channel is not initialized.  CNcomment:指定的通道未初始化
...
/**
\brief Initializes the PVR playing module. CNcomment: 初始化PVR播放模块
\attention \n
...
/**
\brief Deinitializes the PVR playing module.  CNcomment:去初始化PVR播放模块
\attention \n
If you deinitialize the PVR recording module repeatedly, the error code HI_SUCCESS is returned.\n
...
\retval ::HI_SUCCESS Success CNcomment:成功
\retval ::HI_FAILURE          This API fails to be called due to system errors.   CNcomment: 出现系统错误，API调用失败
\retval ::HI_ERR_PVR_BUSY  The PVR playing module is being used.  CNcomment: PVR播放模块还在使用中
\retval ::HI_ERR_PVR_NOT_INIT   The PVR recording module is not initialized.CNcomment:  PVR录制模块未初始化
\see \n
::HI_UNF_PVR_PlayInit
*/
...
/**
\brief Creates a playing channel. CNcomment:创建1路播放通道
\attention \n
...
\param[out] pu32ChnID  ID of the obtained playing channel  CNcomment: 获取到的播放通道ID
\param[in] pstPlayAttr  Pointer to the channel attributes CNcomment: 通道属性配置指针
\param[in] hAvplay      AVPLAY handle. It specifies the APVPLAY to be used. CNcomment: avplay句柄，标识用哪个avplay来播放
...
tCNcomment:s buffer句柄，标识用哪个ts buffer来回放，一般来说，此ts buffer对应的ts端口应该是绑定在hAVPlay对应的demux上的
\retval ::HI_SUCCESS   Success  CNcomment:成功 
\retval ::HI_ERR_PVR_NOT_INIT       The PVR recording module is not initialized.  CNcomment: PVR录制模块未初始化
\retval ::HI_ERR_PVR_NUL_PTR            The pointer is null. CNcomment:  指针参数为空
\retval ::HI_ERR_DMX_INVALID_PARA        The parameter is invalid.  CNcomment: 参数非法
...
\retval ::HI_ERR_PVR_NO_CHN_LEFT        There is no available channel. CNcomment:  已经没有空闲的通道供分配
\retval ::HI_ERR_PVR_FILE_CANT_OPEN      The file cannot be opened.   CNcomment:  无法打开文件
\retval ::HI_ERR_PVR_FILE_NOT_EXIST      The file cannot be played because it does not exist. CNcomment: 文件不存在，无法播放
\retval ::HI_ERR_PVR_NO_MEM             The buffer required for playing cannot be allocated due to insufficient memory. CNcomment: 内存不足，无法分配播放需要的Buffer
\retval ::HI_ERR_PVR_FILE_CANT_READ   The file cannot be read.  CNcomment:   文件读取出错
\see \n
N/A
*/
...
/**
\brief Releases a specified playing channel. CNcomment:释放指定的播放通道
\attention \n
If the channel to be released is not stopped, the error code HI_ERR_PVR_BUSY is returned. 
CNcomment:如果待释放的通道没有停止，将返回错误码::HI_ERR_PVR_BUSY
\param[in] u32ChnID  ID of the channel to be released CNcomment:需要释放的通道号
\retval ::HI_SUCCESS Success CNcomment:成功
\retval ::HI_ERR_PVR_NOT_INIT     The PVR recording module is not initialized.   CNcomment: PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID       The channel ID is invalid.  CNcomment: 通道号非法
...
CNcomment:启动时移播放通道。调用此接口可以根据输入的录制通道号，启动1路时移播放。此接口将根据对应录制通道的参数自动初始化1个播放通道，并开始播放
\attention \n
...
\param[out] pu32PlayChnID   ID of a playing channel CNcomment:播放通道号
\param[in] u32RecChnID    ID of the recording channel to be time-shifted CNcomment: 需要时移的录制通道号
\param[in] hAvplay     AVPLAY handle. It specifies the APVPLAY to be used.   CNcomment:avplay句柄，标识用哪个avplay来播放
\param[in] hTsBuffer    TS buffer handle. It specifies that TS buffer that is used for playback. In general, the TS port corresponding to the TS buffer must be attached to the DEMUX corresponding to the AVPLAY. 
CNcomment:ts buffer句柄，标识用哪个ts buffer来回放，一般来说，此ts buffer对应的ts端口应该是绑定在hAVPlay对应的demux上的
\retval ::HI_SUCCESS Success CNcomment:成功
\retval ::HI_ERR_PVR_NUL_PTR The pointer is null.  CNcomment:指针参数为空
\retval ::HI_ERR_PVR_PLAY_INVALID_DMXID The DEMUX ID received during playing is incorrect. CNcomment:播放时传入了错误的DEMUX ID
\retval ::HI_ERR_PVR_INVALID_CHNID The channel ID is invalid. CNcomment: 通道号非法
\retval ::HI_ERR_PVR_CHN_NOT_INIT The specified channel is not initialized. CNcomment: 指定的通道未初始化
\retval ::HI_ERR_PVR_ALREADY  The specified channel has been started. CNcomment:指定的通道已经启动
\retval ::HI_ERR_PVR_NO_CHN_LEFT  There is no available playing channel.CNcomment: 已经没有空闲的播放通道供分配
\retval ::HI_ERR_PVR_REC_INVALID_STATE  The recording channel is not started.CNcomment:  录制通道没有启动
\retval ::HI_ERR_PVR_NO_MEM   The buffer required for playing cannot be allocated due to insufficient memory.CNcomment: 内存不足，无法分配播放需要的Buffer
\retval ::HI_FAILURE This API fails to be called due to system errors. CNcomment:出现系统错误，API调用失败
\see \n
...
/**
\brief Stops a playing channel.  CNcomment:停止播放通道
\attention \n
...
\param[in] u32PlayChnID Channel ID  CNcomment:通道号
\param[in] pstStopOpt  Pointer to the attribute structure when the AVPLAY stops CNcomment:停止的属性设置
...
CNcomment:通道状态错误。例如：对用::HI_UNF_PVR_PlayStartChn启动的播放通道调用此接口
\see \n
...
/**
\brief Sets the attributes of a playing channel. CNcomment:设置播放通道属性
\attention \n
You can set the dynamic attributes only by calling this API. 
CNcomment:只有动态属性才能通过此接口进行设置
\param[in] u32ChnID    Channel ID CNcomment: 通道号
\param[in] pstPlayAttr  Pointer to the channel attributes to be set  CNcomment:指针类型，指向要设置的通道属性配置
\retval ::HI_SUCCESS Success  CNcomment:成功
\retval ::HI_ERR_PVR_NOT_INIT  The PVR recording module is not initialized. CNcomment:PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID The channel ID is invalid.  CNcomment:通道号非法
\see \n
...
/**
\brief  Obtains the attributes of a playing channel. CNcomment:获取播放通道属性
\attention \n
N/A
\param[in] u32ChnID   Channel ID CNcomment:CNcomment:通道号
\param[out] pstPlayAttr   Pointer to the obtained channel attributes CNcomment:指针类型，指向获取到的通道属性配置
\retval ::HI_SUCCESS  Success CNcomment:成功
\retval ::HI_ERR_PVR_NOT_INIT   The PVR recording module is not initialized.CNcomment: PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID   The channel ID is invalid. CNcomment:  通道号非法
\retval ::HI_ERR_PVR_CHN_NOT_INIT   The specified channel is not initialized. CNcomment: 指定的通道未初始化
...
/**
\brief  Starts a playing channel. CNcomment:启动播放通道
\attention \n
...
CNcomment:通道状态错误。例如：对用::HI_UNF_PVR_PlayStartTimeShift启动的播放通道调用此接口
\see \n
...
/**
\brief  Pauses a playing channel. CNcomment:暂停播放通道
\attention \n
...
\retval ::HI_ERR_PVR_INVALID_CHNID     The channel ID is invalid.  CNcomment:  通道号非法
\retval ::HI_ERR_PVR_CHN_NOT_INIT       The specified channel is not initialized.  CNcomment:指定的通道未初始化
\retval ::HI_ERR_PVR_PLAY_INVALID_STATE   The channel status is incorrect, that is , the channel has been stopped. CNcomment: 通道状态错误：通道已经停止运行
\see \n
...
CNcomment:恢复播放通道。调用此接口可以恢复播放通道，解除播放通道的暂停状态
\attention \n
This API must work with HI_UNF_PVR_PlayPauseChn. In addition, a channel can be resumed only when it is paused. 
CNcomment:此接口与::HI_UNF_PVR_PlayPauseChn接口必须配对使用，只有在通道已经暂停的情况下才允许恢复通道
\param[in] u32ChnID Channel ID  CNcomment:通道号
\retval ::HI_SUCCESS Success  CNcomment:成功
\retval ::HI_ERR_PVR_NOT_INIT       The PVR recording module is not initialized.  CNcomment:PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID      The channel ID is invalid.   CNcomment:通道号非法
\retval ::HI_ERR_PVR_CHN_NOT_INIT     The specified channel is not initialized.   CNcomment:指定的通道未初始化
\retval ::HI_ERR_PVR_PLAY_INVALID_STATE The specified channel is not paused.   CNcomment:指定的通道不在暂停状态
\see \n
...
CNcomment:进行特技播放。调用此接口可以进行特技播放，即进行快进、快退、慢放、正常播放等操作
\attention \n
...
CNcomment:进入特技播放模式后，如果想退回正常播放模式，只需要设置特技播放模式的速度为PVR_PLAY_SPEED_NORMAL
\param[in] u32ChnID      Channel ID CNcomment: 通道号
\param[in] pstTrickMode   Pointer to the information about the trick playing mode  CNcomment:特技播放模式信息指针
\retval ::HI_SUCCESS   Success  CNcomment:成功
\retval ::HI_ERR_PVR_NOT_INIT        The PVR recording module is not initialized.   CNcomment:PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID     The channel ID is invalid.      CNcomment:通道号非法
\retval ::HI_ERR_PVR_CHN_NOT_INIT       The specified channel is not initialized.   CNcomment:指定的通道未初始化
\retval ::HI_ERR_PVR_PLAY_INVALID_STATE   The channel status is incorrect, that is , the channel has been stopped.  CNcomment:通道状态错误：通道已经停止运行
\retval ::HI_ERR_DMX_INVALID_PARA      The parameter is invalid.     CNcomment:参数非法
\retval ::HI_ERR_PVR_NOT_SUPPORT    The trick playing mode is not supported.  CNcomment:不支持的特技播放模式
\see \n
N/A
*/
...
/**
\brief Seeks a specified position to play. CNcomment:定位到指定位置进行播放
\attention \n
...
找不到I帧会返回错误
\param[in] u32ChnID  Channel ID  CNcomment:通道号
\param[in] pstPosition Pointer to the playing position.  CNcomment:播放位置信息指针
\retval ::HI_SUCCESS  Success  CNcomment: 成功
\retval ::HI_ERR_PVR_NOT_INIT        The PVR recording module is not initialized.  CNcomment:PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID        The channel ID is invalid.   CNcomment:通道号非法
\retval ::HI_ERR_PVR_CHN_NOT_INIT       The specified channel is not initialized.   CNcomment:指定的通道未初始化
\retval ::HI_ERR_PVR_PLAY_INVALID_STATE  The channel status is incorrect, that is , the channel has been stopped.  CNcomment: 通道状态错误：通道已经停止运行
\retval ::HI_ERR_DMX_INVALID_PARA       The parameter is invalid.   CNcomment: 参数非法
\retval ::HI_ERR_PVR_NOT_SUPPORT     The seek mode is not supported.   CNcomment:不支持的Seek模式
\retval ::HI_ERR_PVR_FILE_TILL_END       No corresponding frame is sought till the end of a file.  CNcomment:Seek到文件尾没有找到相应的帧
\retval ::HI_ERR_PVR_FILE_TILL_START   No corresponding frame is sought till the start of a file.    CNcomment:Seek到文件头没有找到相应的帧
\retval ::HI_ERR_PVR_FILE_CANT_READ     The file cannot be read.   CNcomment:读取文件失败
\see \n
N/A
*/
...
CNcomment: 逐帧播放。调用此接口可以进行逐帧倒退或者逐帧前进播放
\attention \n
This playing mode is not supported currently. CNcomment:目前不支持逐帧播放
\param[in] u32ChnID     Channel ID  CNcomment:通道号
\param[in] s32Direction  Playing direction. If the value is greater than or equal to 0, the direction is forward; if the value is less than 0, the direction is backward. CNcomment:  播放方向。大于等于0表示前进；小于0表示后退
\retval ::HI_SUCCESS  Success  CNcomment:成功
\retval ::HI_ERR_PVR_NOT_INIT        The PVR recording module is not initialized. CNcomment: PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID      The channel ID is invalid.    CNcomment: 通道号非法
\retval ::HI_ERR_PVR_CHN_NOT_INIT       The specified channel is not initialized.  CNcomment: 指定的通道未初始化
\retval ::HI_ERR_PVR_PLAY_INVALID_STATE   The channel status is incorrect, that is , the channel has been stopped. CNcomment: 通道状态错误：通道已经停止运行
\retval ::HI_ERR_PVR_NOT_SUPPORT   This function is not supported.  CNcomment:不支持的功能
\see \n
N/A
*/
...
/**
\brief Obtains the playing status of the PVR. CNcomment:获取PVR回放的状态
\attention \n
Before calling this API to obtain the playing status, you must create a player. 
CNcomment:获取播放的状态，注意在播放器创建之后调用
\param[in] u32ChnID
\param[in] pstStatus
\retval ::HI_SUCCESS Success  CNcomment: 成功
\retval ::HI_ERR_PVR_NOT_INIT  The PVR recording module is not initialized CNcomment: PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID The channel ID is invalid.  CNcomment:通道号非法
\retval ::HI_ERR_PVR_BUSY   The system is busy. Please try again later. CNcomment:系统忙，遇到这种情况，请重试。
\see \n
N/A
*/
...
/**
\brief Obtains the information about the stream file recorded by the PVR based on the ID of the playing channel.  CNcomment:通过播放通道ID，获取PVR录制的码流文件信息
\attention \n
...
\param[in] pAttr   CNcomment:播放状态信息指针
\retval ::HI_SUCCESS  Success  CNcomment:成功
\retval ::HI_ERR_PVR_NOT_INIT            The PVR playing module is not initialized.  CNcomment:PVR播放模块未初始化
\retval ::HI_ERR_PVR_NUL_PTR           The pointer is null.   CNcomment: 空指针错误
\retval ::HI_ERR_PVR_INVALID_CHNID      The channel ID is invalid.   CNcomment:通道号非法
\retval ::HI_ERR_PVR_CHN_NOT_INIT        The specified channel is not initialized. CNcomment: 指定的通道未初始化
\retval ::HI_ERR_PVR_FILE_CANT_OPEN      The file cannot be opened.  CNcomment:无法打开文件
\retval ::HI_ERR_PVR_FILE_CANT_READ    The file cannot be read.   CNcomment: 无法读文件
\see \n
N/A
*/
...
CNcomment:获取码流文件信息。调用此接口可以在不申请播放通道的情况下获取指定码流文件的信息
\attention \n
...
CNcomment:指向码流文件名而不是索引文件名.任何时候都可以调用此接口获取码流文件的属性
\param[in] pFileName Name of a stream file  CNcomment:码流文件名
\param[in] pAttr   Pointer to the playing status   CNcomment:播放状态信息指针
\retval ::HI_SUCCESS  Success  CNcomment:成功
\retval ::HI_ERR_PVR_NUL_PTR       The pointer is null.    CNcomment:空指针错误
\retval ::HI_ERR_PVR_FILE_CANT_OPEN  The file cannot be opened.  CNcomment:无法打开文件
\retval ::HI_ERR_PVR_FILE_CANT_READ   The file cannot be read. CNcomment:无法读文件
...
/**
\brief  Writes the user data. CNcomment: 写入用户数据
\attention \n
pFileName points to the name of a stream file rather than an index file.\n
...
请在启动录制通道后再写入用户数据信息
\param[in] pFileName Name of a stream file CNcomment: 码流文件名
\param[in] pInfo    Pointer to the user data. The memory is allocated by customers. CNcomment:用户数据指针，空间由用户分配
\param[in] u32UsrDataLen   Length of the user data CNcomment: 用户数据长度
\retval ::HI_SUCCESS  Success  CNcomment:成功
\retval ::HI_ERR_PVR_NUL_PTR       The pointer is null.   CNcomment: 空指针错误
\retval ::HI_ERR_PVR_FILE_CANT_OPEN   The file cannot be opened.CNcomment:无法打开文件
\retval ::HI_ERR_PVR_FILE_CANT_READ  The file cannot be read.  CNcomment:无法读文件
...
/**
\brief  Reads the user data. CNcomment: 读取用户数据
\attention \n
pFileName points to the name of a stream file rather than an index file.\n
...
\param[in] pFileName    Name of a stream file CNcomment:码流文件名
\param[in] pInfo    User data buffer. The memory is allocated by customers.   CNcomment:用户数据缓冲区，空间由用户分配
\param[in] u32BufLen   Buffer length .CNcomment:缓冲区长度
\param[in] pUsrDataLen Actual length of the obtained user data .CNcomment:实际读取到的用户数据长度
\retval ::HI_SUCCESS  Success  CNcomment:成功
\retval ::HI_ERR_PVR_NUL_PTR        The pointer is null.      CNcomment: 空指针错误
\retval ::HI_ERR_PVR_FILE_CANT_OPEN    The file cannot be opened. CNcomment:无法打开文件
\retval ::HI_ERR_PVR_FILE_CANT_READ    The file cannot be read.  CNcomment:无法读文件
...
CNcomment: 注册事件回调函数。调用此接口可以注册PVR事件的回调函数，从而对PVR录制、播放过程中产生的事件进行处理
\attention \n
...
\param[in] enEventType  Type of the event to be registered.  CNcomment: 想要注册的事件类型
\param[in] callBack   Event handling callback function.   CNcomment: 事件处理函数
\param[in] args      Parameters of a customized callback function.    CNcomment:用户自定义回调函数的参数
\retval ::HI_SUCCESS   Success CNcomment: 成功
\retval ::HI_ERR_PVR_INTF_EVENT_INVAL   The event is invalid.  CNcomment: 非法的事件
\retval ::HI_ERR_PVR_ALREADY         The registering event has been registered.    CNcomment: 尝试对已经注册的事件再次注册
\retval ::HI_ERR_PVR_INTF_EVENT_NOREG    Registration fails because the callback function pointer is incorrect. CNcomment:  回调函数指针出错，无法注册成功
\see \n
N/A
*/
...
/**
\brief  Deregisters a PVR event. CNcomment: 去注册PVR事件的回调函数
\attention \n
You can call this API to deregister an event. If a registered event is not deregistered, it is always valid. 
CNcomment: 可以使用此接口来去注册1个事件，否则已经注册的事件将一直保持有效
\param[in] enEventType      Type of the event to be deregistered    CNcomment: 想要去注册的事件类型
\retval ::HI_SUCCESS   Success  CNcomment:成功
\retval ::HI_ERR_PVR_INTF_EVENT_INVAL  The event is invalid. CNcomment: 非法的事件
\retval ::HI_ERR_PVR_INTF_EVENT_NOREG  The deregistering event is not registered. CNcomment: 对没有注册的事件进行去注册
\see \n
N/A
*/
...
\param[in] pAttr
\retval ::HI_SUCCESS Success CNcomment:  成功
\retval ::HI_ERR_PVR_NOT_SUPPORT  This function is not supported. CNcomment: 不支持此功能
\see \n
N/A
*/
...
/**
\brief Controls whether to output debugging information.  CNcomment:配置是否输出调试信息
\attention \n
The debugging information about the severity level higher than the error level is output. 
CNcomment:默认输出error 以上级别的调试信息
\param[in] enDebugLevel  Output level of the debugging information CNcomment: 调试信息输出级别
\retval none
\see \n
N/A
*/
...
/**
\brief  Deletes the stream files and index files generated during recording. CNcomment:删除录制时生成的码流文件和索引文件
\attention \n
pFileName points to the name of a stream file rather than an index file.\n
...
/**
\brief
Register extra write callback function.When the stream file need to be extra processed  CNcomment: 注册外部读、写数据回调函数。当文件需要特殊处理时注册，如私有协议加扰的节目。
\attention \n
N/A
\param[in] u32ChnID    Channel ID  CNcomment:通道号
\param[in] enExtraCallbackType  Callback function type CNcomment: 回调函数类型
\retval ::HI_SUCCESS Success  CNcomment: 成功
\retval ::HI_ERR_PVR_NOT_INIT  The PVR recording module is not initialized CNcomment: PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID The channel ID is invalid.  CNcomment:通道号非法
\retval ::HI_ERR_PVR_CHN_NOT_INIT   Specified channel is not initialized   CNcomment:   指定的通道未初始?
\see \n
N/A
*/
...
/**
\brief Deregisters extra write callback function.When the stream file need to be extra processed  CNcomment:去注册外部读、写数据回调函数。
\attention \n
N/A
\param[in] u32ChnID  Channel ID  CNcomment:通道号
\param[in] enExtraCallbackType  Callback function type CNcomment: 回调函数类型
...
\retval ::HI_ERR_PVR_NOT_INIT  The PVR recording module is not initialized CNcomment: PVR录制模块未初始化
\retval ::HI_ERR_PVR_INVALID_CHNID The channel ID is invalid.  CNcomment:通道号非法
\retval ::HI_ERR_PVR_CHN_NOT_INIT   Specified channel is not initialized   CNcomment:   指定的通道未初始化
\see \n
N/A
*/
